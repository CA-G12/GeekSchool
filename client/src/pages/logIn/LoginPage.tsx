                ...
                <div>
                    ...
                    >
                        <Form.Item
                            style={{ width: "100%" }}
                            name="email"
                            rules={[{ type: 'email', required: true, message: 'الرجاء إدخال البريد الالكتروني' }]}
                        >
                        ...
                        <Form.Item
                            style={{ width: "100%" }}
                            name="password"
                            rules={[{ min:5, max:15, required: true, message: 'الرجاء إدخال كلمة المرور' }]}
                        >
                        ...
                        <Form.Item style={{ width: "100%" }}>
                            <Button type="primary" htmlType="submit"
                                style={{
                                    ...
                                    width: "100%",
                                    border: 'none',
                                    background: "linear-gradient(180deg, #13DE82 0%, #0AB68B 100%)"
                        ...
                        <p style={{width: "100%", textAlign: "left" }}>لم تنشئ أي حساب مسبقًا؟ <span style={{color: '#0AB28B' }}>أنشئ حساب</span></p>
